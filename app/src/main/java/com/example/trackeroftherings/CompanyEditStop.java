...
public class CompanyEditStop extends Fragment {
 ...
 */
    ...
    public void showBottomSheetDialog(){
        ...
        bottomBar.setContentView(R.layout.bottom_dialog_edit_stop);
        EditText stopName = bottomBar.findViewById(R.id.editTextStopName);
        if(status == EDIT) {
